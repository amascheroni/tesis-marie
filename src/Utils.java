...
public class Utils {
    ...
    public static boolean crearReporte(String path, String browser1, String browser2, String nombre, String fecha, int pxIgual, int pixDiff) {
        
        try {
            String fechaYhora = "Fecha: " + fecha.replaceAll(" ", " - Hora: ");
            
            File templateReportes =  new File("C://pixeldiff//utils//templateJarReportes.html");
